import { EditIcon, Loader2Icon, MoreVertical, Notebook } from "lucide-react";
...
function ResumeCards({ resume, refreshData }) {
  ...
  return (
    <div>
      ...
      >
        <h2 className="text-sm">{title || "Untitled Resume"}</h2>
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent>
            ...
            <DropdownMenuItem
              onClick={() =>
                navigation("/viewMyResume/" + resume.id + "/viewResume")
              }
            >
              View
            </DropdownMenuItem>
